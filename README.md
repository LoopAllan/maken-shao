...
《Maken Shao（魔剣爻）》的可驗證、可維護繁體中文知識庫網站。v0.4 已提供官方來源支持的世界觀／系統、22 筆繁中／日文／英文對照角色資料、17 張可追溯官方角色圖與 18 名交叉驗證可操作角色資料，以及附來源與查證狀態的 PS2 日版流程骨架；其餘角色、Boss、結局與 100% 細節仍依版本策略逐步建置。

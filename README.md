...
《Maken Shao（魔剣爻）》的可驗證、可維護繁體中文知識庫網站。目前已提供官方／社群來源支持的世界觀與系統 Knowledge、28 名角色的結構化完整 profile、角色招式與取得流程、地圖圖鑑、PS2 日版流程，以及崑崙與紫禁城兩條證據可支持終盤路線的結局詳細頁。全站內容預設完整顯示，不設名稱遮蔽或劇透收合；Boss 不另設重複頁面，改由角色圖鑑標籤承載。

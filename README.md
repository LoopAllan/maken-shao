...
《Maken Shao（魔剣爻）》的可驗證、可維護繁體中文知識庫網站。v0.4 已提供官方來源支持的世界觀／系統、MegaTen Wiki「MX」角色導覽中的 28 筆繁中／日文／英文對照角色資料、28 張具檔案頁與 checksum 的 Wiki 本地縮圖、分類 tabs、標籤查詢，以及附來源與查證狀態的 PS2 日版流程骨架。全站內容預設完整顯示，不設名稱遮蔽或收合；Boss、結局與 100% 細節仍依版本策略逐步建置。
